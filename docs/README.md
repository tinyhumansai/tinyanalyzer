...
The analyzer's own contract — what it measures, what it approximates, and what
it refuses to guess — is in
[`specs/analysis-contract.md`](specs/analysis-contract.md).
